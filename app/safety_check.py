...
def check_image_safe(image: Image.Image):
    ...
    # Violence Check (chỉ chạy nếu ảnh không nhạy cảm)
    ...
    if violence_label.lower() in ["violent", "violence", "LABEL_0","LABEL_1"] and violence_score > 50:
        return f"🚨 Ảnh KHÔNG an toàn:\n- Ảnh chứa bạo lực ({violence_label} - {violence_score:.2f}%)"
